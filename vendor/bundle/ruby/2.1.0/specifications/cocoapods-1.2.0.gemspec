...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<cocoapods-trunk>.freeze, ["< 2.0", ">= 1.1.2"])
      s.add_runtime_dependency(%q<cocoapods-try>.freeze, ["< 2.0", ">= 1.1.0"])
      s.add_runtime_dependency(%q<molinillo>.freeze, ["~> 0.5.5"])
      s.add_runtime_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.4.1"])
      ...
      s.add_dependency(%q<cocoapods-trunk>.freeze, ["< 2.0", ">= 1.1.2"])
      s.add_dependency(%q<cocoapods-try>.freeze, ["< 2.0", ">= 1.1.0"])
      s.add_dependency(%q<molinillo>.freeze, ["~> 0.5.5"])
      s.add_dependency(%q<xcodeproj>.freeze, ["< 2.0", ">= 1.4.1"])
